...
<li><s:a href="http://forums.slimdevices.com/member.php?8264-Stoker" 
         ...
         (<s:a href="quick_start_guide.jsp">CSOS on the Wandboard: Quick Start Guide</s:a>)</li>
<li><s:a href="http://forums.slimdevices.com/member.php?12588-dsdreamer" 
         target="blank_">dsdreamer</s:a>
         (<s:a href="jivelite_about.jsp">Jivelite: Control of Audio Playback on the Wandboard</s:a>)</li>
